...
four deterministic demo users, and imports/exports local Auth state from the ignored
.firebase/emulator-data directory so restarting the emulator does not recreate user UIDs.
