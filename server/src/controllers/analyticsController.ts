import type { AppRequest, AppResponse, LooseRecord } from "../types/domain";
...
const safeQuery = async <T extends LooseRecord = LooseRecord>(sql: string, params: QueryParams = [], fallback: T[] = []): Promise<T[]> => {
    try {
