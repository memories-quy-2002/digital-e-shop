...
export class NestAuthController {
    ...
    async registerUser(
        ...
        const sessionPayload = await this.authService.registerUser(body.idToken, body.user);
    ...
    async userLogin(
        ...
        const sessionPayload = await this.authService.loginUser(body.idToken, body.rememberMe);
