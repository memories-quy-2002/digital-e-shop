    ...
    return (
        <Layout>
            ...
            <article className="success__container">
                ...
                <p className="success__container__eyebrow">Thank you {userData && !loading ? userData.username : "there"}!</p>
                ...
                <section className="success__container__details">
                    ...
                    <div>
                        ...
                        <p>Placed on {combinedData?.placedAt ? formatUtcDateTime(combinedData.placedAt) : formatUtcDateTime()}</p>
                        <p>
                            Payment method:{" "}
