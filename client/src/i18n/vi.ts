...
const vi: Dictionary = {
  ...
  wishlistAlerts: {
    ...
    priceDropNotificationTitle: (productName: string) =>
      `${productName} vừa giảm giá`,
    priceDropNotificationMessage: (productName: string, currentPrice: string) =>
      `${productName} hiện có giá ${currentPrice}. Mở sản phẩm để xem ưu đãi.`,
    backInStockNotificationTitle: (productName: string) =>
      `${productName} đã có hàng trở lại`,
    backInStockNotificationMessage: (productName: string) =>
      `${productName} đã sẵn sàng để mua. Mở sản phẩm khi hàng còn sẵn.`,
  },
  comparison: {
    pageTitle: "So sánh sản phẩm",
    pageDescription:
      "Xem những khác biệt quan trọng trước khi chọn thiết bị tiếp theo.",
    ...
    removeComparisonProduct: (name: string) =>
      `Xóa ${name} khỏi danh sách so sánh`,
    ...
    emptyDescription:
      "Chọn sản phẩm từ cửa hàng để so sánh thông số, giá, tồn kho và bảo hành.",
    oneProductTitle: "Hãy chọn ít nhất hai sản phẩm để so sánh.",
    categoryMismatch:
      "Không thể so sánh các sản phẩm thuộc danh mục khác nhau.",
  ...
  account: {
    ...
    description:
      "Xem nhanh các giao dịch mua, thông tin giao hàng và hoạt động tài khoản.",
    ...
    verificationSignIn:
      "Vui lòng đăng nhập lại trước khi yêu cầu liên kết xác minh mới.",
    ...
    reviewOrdersDescription:
      "Theo dõi giao dịch mua và đặt lại các sản phẩm còn hàng.",
    manageShipping: "Quản lý giao hàng",
    manageShippingDescription:
      "Lưu sẵn địa chỉ giao hàng cho lần thanh toán tiếp theo.",
    recentOrders: "Đơn hàng gần đây",
    viewAll: "Xem tất cả",
    noOrders: "Chưa có đơn hàng",
    noOrdersDescription:
      "Đơn hàng gần đây sẽ xuất hiện sau khi bạn thanh toán.",
    ...
    noSavedAddressesDescription:
      "Thêm địa chỉ giao hàng để thanh toán lần sau nhanh hơn.",
    ...
    notifications: {
      ...
      unreadSummary: (count: number) =>
        count + " cập nhật chưa đọc từ hoạt động tài khoản.",
      emptySummary:
        "Cập nhật đơn hàng, giao hàng và tài khoản sẽ hiển thị ở đây.",
      updating: "Đang cập nhật...",
      markAllRead: "Đánh dấu tất cả đã đọc",
      noNotifications: "Chưa có thông báo",
      noNotificationsDescription:
        "Cập nhật đơn hàng, thay đổi giao hàng và nhắc nhở tài khoản sẽ hiển thị ở đây.",
      ...
      markAllComplete: (updated: number) =>
        updated > 0
          ? "Đã đánh dấu tất cả thông báo là đã đọc."
          : "Không có thông báo chưa đọc.",
      updateError: "Không thể cập nhật thông báo.",
      orderType: "Đơn hàng",
      orderPlacedTitle: (id: number | string) =>
        "Đơn hàng #" + id + " đã được đặt",
      orderCompletedTitle: (id: number | string) =>
        "Đơn hàng #" + id + " đã hoàn tất",
      orderCanceledTitle: (id: number | string) =>
        "Đơn hàng #" + id + " đã bị hủy",
      orderPlacedMessage: (total: string) =>
        "Tổng đơn hàng của bạn là " +
        total +
        ". Chúng tôi sẽ cập nhật tiến trình khi đơn hàng được xử lý.",
      orderCompletedMessage:
        "Trạng thái đơn hàng đã chuyển sang hoàn tất. Mở lịch sử đơn hàng để xem toàn bộ tiến trình.",
      orderCanceledMessage:
        "Trạng thái đơn hàng đã chuyển sang đã hủy. Mở lịch sử đơn hàng để xem toàn bộ tiến trình.",
    },
  },
  orders: {
    ...
    description:
      "Theo dõi giao dịch gần đây, xem thông tin thanh toán và đặt lại sản phẩm còn hàng.",
    ...
    noOrders: "Chưa có đơn hàng",
    noOrdersDescription:
      "Lịch sử thanh toán hoàn tất sẽ xuất hiện sau khi bạn đặt đơn đầu tiên.",
    startShopping: "Bắt đầu mua sắm",
    listTitle: "Đơn hàng",
    totalOrdersCount: (count: number) => count + " đơn hàng",
    pageOf: (current: number, total: number) =>
      "Trang " + current + " trên " + total,
    ...
    cancelSuccess:
      "Đơn hàng đang xử lý đã được hủy và tồn kho đã được hoàn lại.",
  ...
  addresses: {
    ...
    title: "Sổ địa chỉ",
    description:
      "Lưu thông tin giao hàng một lần và sử dụng lại ở bước thanh toán.",
    ...
    formDescription:
      "Lưu thông tin người nhận và vị trí giao hàng cho lần thanh toán sau.",
    ...
    noSavedAddresses: "Chưa có địa chỉ đã lưu",
    emptyDescription:
      "Thêm địa điểm giao hàng đầu tiên để thanh toán nhanh hơn và giữ thông tin giao hàng nhất quán.",
    edit: "Chỉnh sửa",
  ...
  shops: {
    ...
    filterCount: (count: number) =>
      `${count} b\u1ed9 l\u1ecdc \u0111\u00e3 ch\u1ecdn`,
    closeFilters: "\u0110\u00f3ng b\u1ed9 l\u1ecdc",
    filterSheetDescription:
      "Ch\u1ecdn danh m\u1ee5c, th\u01b0\u01a1ng hi\u1ec7u v\u00e0 kho\u1ea3ng gi\u00e1 \u0111\u1ec3 thu h\u1eb9p danh s\u00e1ch s\u1ea3n ph\u1ea9m.",
    activeFilters: "B\u1ed9 l\u1ecdc \u0111ang ch\u1ecdn",
    clearAll: "X\u00f3a t\u1ea5t c\u1ea3",
    removeFilter: (label: string) => `B\u1ecf b\u1ed9 l\u1ecdc ${label}`,
    activePriceRange: (minimum: string, maximum: string) =>
      `T\u1eeb ${minimum} \u0111\u1ebfn ${maximum}`,
    showFilters: "Hi\u1ec7n b\u1ed9 l\u1ecdc",
    hideFilters: "\u1ea8n b\u1ed9 l\u1ecdc",
    categories: "Danh m\u1ee5c",
    categoryCamera: "M\u00e1y \u1ea3nh",
    categoryConsole: "M\u00e1y ch\u01a1i game",
    categoryGraphicsCard: "Card \u0111\u1ed3 h\u1ecda",
    categoryHeadphone: "Tai nghe",
    categoryLaptop: "Laptop",
    categoryMonitor: "M\u00e0n h\u00ecnh",
    categoryPc: "M\u00e1y t\u00ednh \u0111\u1ec3 b\u00e0n",
    categorySmartphone: "\u0110i\u1ec7n tho\u1ea1i th\u00f4ng minh",
    brands: "Th\u01b0\u01a1ng hi\u1ec7u",
    searchBrands: "T\u00ecm th\u01b0\u01a1ng hi\u1ec7u",
    noBrandsFound:
      "Kh\u00f4ng t\u00ecm th\u1ea5y th\u01b0\u01a1ng hi\u1ec7u ph\u00f9 h\u1ee3p.",
    priceRange: "Kho\u1ea3ng gi\u00e1",
    priceHelp:
      "Nh\u1eadp kho\u1ea3ng gi\u00e1 c\u1ee5 th\u1ec3 ho\u1eb7c ch\u1ecdn nhanh ng\u00e2n s\u00e1ch cho s\u1ea3n ph\u1ea9m b\u1ea1n mu\u1ed1n xem.",
    minPrice: "T\u1eeb",
    maxPrice: "\u0110\u1ebfn",
    ...
    team: [
      {
        ...
        detail:
          "Biến thông số và thông tin bảo hành thành lựa chọn dễ hiểu hơn.",
      },
      {
      ...
      },
      {
        ...
        detail:
          "Hỗ trợ câu hỏi về tài khoản, giao hàng, thanh toán, đổi trả và bảo hành.",
      },
    ],
  },
  contact: {
