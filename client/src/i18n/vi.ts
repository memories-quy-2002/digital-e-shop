...
const vi: Dictionary = {
  ...
  wishlistAlerts: {
    ...
    loadError: 'Không thể tải thông báo sản phẩm.',
    retry: 'Thử tải lại thông báo sản phẩm',
    loginRequiredTitle: 'Yêu cầu đăng nhập',
    loginRequiredMessage: 'Hãy đăng nhập để quản lý thông báo sản phẩm.',
  ...
  comparison: {
    ...
    pageDescription: 'Xem những khác biệt quan trọng trước khi chọn thiết bị tiếp theo.',
    ...
    removeComparisonProduct: (name: string) => `Xóa ${name} khỏi danh sách so sánh`,
    clear: 'Bỏ chọn tất cả',
    clearAll: 'Xóa tất cả',
    compareNow: 'So sánh sản phẩm',
    addToCompare: 'Thêm vào so sánh',
    removeFromCompare: 'Bỏ khỏi so sánh',
    differencesOnly: 'Chỉ hiển thị điểm khác nhau',
    specifications: 'Thông số kỹ thuật',
    warranty: 'Bảo hành',
    warrantyDuration: (months: number) => `${months} tháng`,
    availability: 'Tình trạng hàng',
    inStock: (count: number) => `Còn ${count} sản phẩm`,
    outOfStock: 'Hết hàng',
    addToCart: (name: string) => `Thêm ${name} vào giỏ hàng`,
    loading: 'Đang tải bảng so sánh…',
    emptyTitle: 'Danh sách so sánh đang trống',
    emptyDescription: 'Chọn sản phẩm từ cửa hàng để so sánh thông số, giá, tồn kho và bảo hành.',
    oneProductTitle: 'Hãy chọn ít nhất hai sản phẩm để so sánh.',
    categoryMismatch: 'Không thể so sánh các sản phẩm thuộc danh mục khác nhau.',
    invalidLink: 'Liên kết so sánh này không hợp lệ.',
    notFound: 'Không tìm thấy một hoặc nhiều sản phẩm.',
    loadError: 'Không thể tải bảng so sánh lúc này.',
    retry: 'Thử lại',
    added: 'Đã thêm vào giỏ hàng',
    removed: 'Đã bỏ khỏi danh sách so sánh',
    limitReached: 'Bạn có thể so sánh tối đa bốn sản phẩm cùng lúc.',
    missingValue: 'Chưa có thông tin',
