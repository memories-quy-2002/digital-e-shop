const en = {
    ...
    contact: {
        ...
        metaDescription: "Contact Digital-E about product questions, orders, accounts, payments, delivery, returns, or feedback.",
    ...
    support: {
        ...
        metaDescription: "Find clear help with Digital-E products, orders, payments, delivery, returns, warranties, and account access.",
        ...
        paymentText: "Get help with cash on delivery, bank-transfer confirmation, or a checkout attempt that did not go through.",
        ...
        faq1Answer: "Sign in and open Order History. You can review the order status, payment method, total, delivery address, and items in one place.",
