const en = {
  ...
  wishlistAlerts: {
    ...
    priceDropNotificationMessage: (productName: string, currentPrice: string) =>
      `${productName} is now ${currentPrice}. Open the product to review the offer.`,
    backInStockNotificationTitle: (productName: string) =>
      `${productName} is back in stock`,
    backInStockNotificationMessage: (productName: string) =>
      `${productName} is available again. Open the product while stock is available.`,
  },
  comparison: {
    pageTitle: "Compare products",
    pageDescription:
      "Review the differences that matter before you choose your next device.",
    ...
    emptyDescription:
      "Choose products from the shop to compare their specifications, price, stock, and warranty.",
  ...
  account: {
    ...
    title: "My account",
    description:
      "A quick view of your purchases, delivery details, and account activity.",
    ...
    verificationSignIn:
      "Please sign in again before requesting a new verification link.",
    ...
    noSavedAddressesDescription:
      "Add a delivery address to speed up future checkout.",
    ...
    notifications: {
      ...
      noNotificationsDescription:
        "Order updates, delivery changes, and account reminders will appear here.",
      ...
      markAllComplete: (updated: number): string =>
        updated > 0
      ...
      orderPlacedMessage: (total: string) =>
        "Your order total is " +
        total +
        ". We will update this timeline as the order moves forward.",
      orderCompletedMessage:
        "The order status changed to completed. Open your order history to see the full timeline.",
      orderCanceledMessage:
        "The order status changed to canceled. Open your order history to see the full timeline.",
    },
  },
  orders: {
    ...
    title: "Order history",
    description:
      "Track recent purchases, review payment details, and reorder items that are still available.",
    ...
    noOrders: "No orders yet",
    noOrdersDescription:
      "Your completed checkout history will appear here once you place your first order.",
    startShopping: "Start shopping",
    listTitle: "Orders",
    ...
    cancelSuccess:
      "Your pending order was canceled and inventory was released.",
  ...
  addresses: {
    ...
    title: "Address book",
    description:
      "Save reliable delivery details once, then use them again at checkout.",
    ...
    formDescription:
      "Keep recipient details and delivery locations ready for future checkout.",
    ...
    noSavedAddresses: "No saved addresses yet",
    emptyDescription:
      "Add your first delivery location to make checkout faster and keep shipping details consistent.",
    edit: "Edit",
    deleteAddress: "Delete address",
    deleteMessage: (label: string) =>
      'Delete "' + label + '" from your address book?',
    delete: "Delete",
  ...
  shops: {
    ...
    filterSheetDescription:
      "Choose categories, brands, and a price range to narrow the catalog.",
    ...
    categoryGraphicsCard: "Graphics card",
    categoryHeadphone: "Headphones",
    categoryLaptop: "Laptop",
    categoryMonitor: "Monitor",
    categoryPc: "Desktop PC",
    ...
    priceHelp:
      "Set an exact budget or choose a quick range for your next build.",
    minPrice: "From",
    maxPrice: "To",
